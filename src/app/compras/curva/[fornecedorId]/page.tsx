...
function CurvaCard({
  ...
  return (
    <div className={`rounded-[20px] border ${config.border} ${config.bg} p-4 sm:p-5 transition-all hover:shadow-md`}>
      ...
      <div className={`text-2xl sm:text-3xl font-bold ${config.text}`}>{total}</div>
    ...
    <DashboardLayout>
      <div className="max-w-[1600px] mx-auto">
        ...
        <nav className="flex items-center gap-2 text-sm text-[#838383] mb-4">
          ...
          <span className="text-[#344054] font-medium truncate max-w-[120px] sm:max-w-[200px]">
        ...
        {/* Filtros */}
        <div className="bg-white rounded-[20px] shadow-[0px_0px_12.4px_1px_rgba(137,170,255,0.1)] p-4 sm:p-5 mb-6">
          <div className="flex flex-wrap items-end gap-3 sm:gap-4">
            <div>
              ...
              <select
                ...
                className="w-full sm:w-32 px-3 py-2.5 border border-[#EDEDED] rounded-xl text-sm text-[#344054] bg-[#FBFBFB] focus:outline-none focus:ring-2 focus:ring-[#336FB6] focus:border-transparent transition-all"
              >
        ...
        {/* Tabela de Produtos */}
        <div className="bg-white rounded-[20px] shadow-[0px_0px_12.4px_1px_rgba(137,170,255,0.1)] p-4 sm:p-5 mb-28">
