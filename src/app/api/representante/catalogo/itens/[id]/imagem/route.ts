...
export async function POST(
  ...
  try {
    ...
    console.error('Erro no upload de imagem (representante):', error)
...
export async function PUT(
  ...
  try {
    ...
    console.error('Erro ao salvar URL da imagem (representante):', error)
    return NextResponse.json({ error: 'Erro interno' }, { status: 500 })
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Erro ao remover imagem (representante):', error)
    return NextResponse.json({ error: 'Erro interno' }, { status: 500 })
  }
}
