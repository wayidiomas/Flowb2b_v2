...
export async function POST(
  ...
  try {
    ...
    // Buscar conferência validando ownership e status
    ...
    if (existente) {
      ...
      // Inserir novo item com snapshot do estoque_sistema (ignorar modo)
    ...
    // Atualizar total_itens da conferência
...
export async function DELETE(
  ...
  try {
    ...
    // Validar ownership da conferência
