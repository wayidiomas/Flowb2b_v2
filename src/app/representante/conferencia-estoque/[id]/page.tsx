...
export default function RepresentanteConferenciaEstoqueDetalhePage() {
    ...
    return (
      <RepresentanteLayout>
        <div className="max-w-2xl mx-auto text-center py-12">
          ...
          <Button variant="outline" onClick={() => router.push('/representante/conferencia-estoque')}>
            Voltar
          </Button>
        </div>
      </RepresentanteLayout>
      ...
      <div className="max-w-2xl mx-auto space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            {conferencia.fornecedor_nome && (
              <p className="text-xs text-gray-500">Fornecedor: {conferencia.fornecedor_nome}</p>
            )}
          </div>
          <Button
            variant="outline"
