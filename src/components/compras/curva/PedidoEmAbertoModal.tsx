    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-4 border-t border-[#EDEDED] bg-[#FBFBFB] flex gap-3">
          ...
          {onContinuarSemDesconto && (
            <button
              onClick={onContinuarSemDesconto}
              disabled={loading}
              className="flex-1 py-2.5 px-4 rounded-xl border border-[#336FB6] text-[#336FB6] font-medium hover:bg-[#336FB6]/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
