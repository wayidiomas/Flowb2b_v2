...
export function SidebarAcoes({ resumo, onNovoPedido, onGerarAutomatico, onImprimir, isCollapsed, onToggleCollapse }: SidebarAcoesProps) {
  ...
  if (isCollapsed) {
    return (
      <div className="hidden md:block w-[48px] flex-shrink-0 transition-all duration-300 ease-in-out">
  ...
  return (
    <div className="hidden md:block w-[280px] 2xl:w-[320px] flex-shrink-0 transition-all duration-300 ease-in-out">
