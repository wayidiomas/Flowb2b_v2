...
function SocialIcon({ platform, size = 24, className = '' }: SocialIconProps) {
  const icons = {
...
export { SocialIcon, SocialButton, GoogleIcon, FacebookIcon, AppleIcon }
export type { SocialIconProps, SocialButtonProps }
