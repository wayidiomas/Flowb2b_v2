...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // Modal global de atualizações pendentes (Sprint 3 do fluxo de catálogo)
  const {
    shouldShow: showAtualizacoesModal,
    data: atualizacoesData,
    remindTomorrow,
    dismissForSession
  } = useShowAtualizacoesPendentesModal()
  ...
  return (
    <div className="min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      {/* Modal global de atualizações pendentes — Sprint 3 do fluxo de catálogo */}
      {!showOnboarding && !showTrialModal && !blingRevoked && showAtualizacoesModal && (
        <AtualizacoesPendentesModalGlobal
          data={atualizacoesData}
          onRemindTomorrow={remindTomorrow}
