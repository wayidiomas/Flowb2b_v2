...
import { WhatsappLogo, FilePdf, Keyboard, ArrowsClockwise } from '@phosphor-icons/react'

const icons = [
  { Icon: WhatsappLogo, label: 'WhatsApp' },
  { Icon: FilePdf, label: 'PDF' },
  { Icon: Keyboard, label: 'Digitar' },
  { Icon: ArrowsClockwise, label: 'Refazer' },
]

export const ProblemCycleAnimation = memo(function ProblemCycleAnimation() {
  return (
    <div className="relative mt-6 flex items-center justify-center">
      ...
      >
        {icons.map(({ Icon, label }, i) => {
          // Position each icon at 0°, 90°, 180°, 270° on the circle
