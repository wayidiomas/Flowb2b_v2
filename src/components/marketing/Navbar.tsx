...
const ENTRAR_OPTIONS = [
  { label: 'Lojista', href: '/login' },
  { label: 'Fornecedor', href: '/fornecedor/login' },
  { label: 'Representante', href: '/representante/login' },
  { label: 'Admin', href: '/login' }, // admin entra via /login com role superadmin
] as const

function EntrarDropdown() {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="inline-flex items-center gap-1.5 text-sm font-medium px-3 py-1.5 rounded-full text-white/80 hover:text-white transition-colors duration-300"
        aria-haspopup="menu"
        aria-expanded={open}
      >
        Entrar
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex justify-center pointer-events-none">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            {/* Right side: Entrar dropdown + CTA */}
